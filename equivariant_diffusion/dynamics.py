...
from equivariant_diffusion.egnn_new import EGNN, GNN, GIN, EGNNHybrid
...
class EGNNDynamics(nn.Module):
    def __init__(self, atom_nf, residue_nf,
                 ...
                 reflection_equivariant=True, edge_embedding_dim=None, alg="gat_hyb"):
        super().__init__()
        self.mode = mode
        ...
        if mode == 'egnn_dynamics':
            self.egnn = EGNN(
                ...
                n_layers=n_layers, attention=True, tanh=tanh,
            ...
            if alg=="gat_hyb":
                ...
                normalization_factor=normalization_factor,
                aggregation_method=aggregation_method,
                reflection_equiv=reflection_equivariant,use_gin=False, use_gat=True,use_mha=False
                )
            elif alg=="egnn":
                self.egnn = EGNN(
                in_node_nf=dynamics_node_nf, in_edge_nf=self.edge_nf,
                ...
                normalization_factor=normalization_factor,
                aggregation_method=aggregation_method,
                reflection_equiv=reflection_equivariant,use_gin=False, use_gat=True,use_mha=True
                )
            ...
            self.gnn = GNN(
                ...
                aggregation_method=aggregation_method)
            print(self.gnn)
        elif mode == 'gin_dynamics':
            self.gnn = GIN(
                in_node_nf=dynamics_node_nf + n_dims, in_edge_nf=self.edge_nf, hidden_nf=hidden_nf, 
